...
// Sets default values
APZ_EquippableShovel::APZ_EquippableShovel()
{
	...
	HitVolume->OnComponentBeginOverlap.AddDynamic(this, &APZ_EquippableShovel::OnHitVolumeBeginOverlap);
}

void APZ_EquippableShovel::Activate(APZ_PlayerCharacter* InstigatorOwner)
{
	Super::Activate(InstigatorOwner);
}

void APZ_EquippableShovel::OnEquip(APZ_PlayerCharacter* NetOwner)
{
	Super::OnEquip(NetOwner);
}

void APZ_EquippableShovel::OnUnequip()
{
	Super::OnUnequip();
}

void APZ_EquippableShovel::SetActiveVolumeEnabled(bool IsEnabled)
{
...
FVector APZ_EquippableShovel::ComputeLaunchDirection(const FVector& Forward2D) const
{
...
void APZ_EquippableShovel::OnHitVolumeBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
